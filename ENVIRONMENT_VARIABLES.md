...
- `SNAPSHOT_UPDATE_INTERVAL` (optional, legacy fallback) - wired snapshot interval when `SNAPSHOT_INTERVAL_WIRED_MINUTES` is not set (values > 60 are treated as seconds and converted to minutes)
