...
class BlinkMixin:
    ...
    async def build_switch(self: Blink2Mqtt, sync_module: dict[str, str]) -> str:
        ...
        device = {
            ...
            "cmps": {
                "armed": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(sync_module["device_name"], "armed"),
                ...
                "local_storage": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(sync_module["device_name"], "local_storage"),
        ...
        if not self.is_discovered(device_id):
            self.logger.info(
                f'added sync module: "{sync_module["device_name"]}" [Blink {sync_module["device_type"]}] '
                f"('{self.get_device_name(device_id)}') serial={device_id}"
            )
    ...
    async def build_camera(self: Blink2Mqtt, camera: dict[str, str]) -> str:
        ...
        device = {
            ...
            "cmps": {
                "snapshot": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "snapshot"),
                ...
                "eventshot": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "eventshot"),
                ...
                "motion": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "motion"),
                ...
                "motion_detection": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "motion_detection"),
                ...
                "save_snapshots": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "save_snapshots"),
                ...
                "nightvision": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "nightvision"),
                ...
                "temperature": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "temperature"),
                ...
                "battery_status": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "battery_status"),
                ...
                "wifi_signal": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "wifi_signal"),
                ...
                "last_event": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "last_event"),
                ...
                "last_event_time": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(camera["device_name"], "last_event_time"),
        ...
        if not self.is_discovered(device_id):
            self.logger.info(
                f"added camera: \"{camera['device_name']}\" [Blink {camera['device_type']}] ('{self.get_device_name(device_id)}') serial={device_id}"
            )
            await self.publish_device_discovery(device_id)
