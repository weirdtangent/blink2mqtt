        ...
        device = {
            ...
            "cmps": {
                "server": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service, "server"),
                ...
                "api_calls": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service, "api_calls"),
                ...
                "rate_limited": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service, "rate_limited"),
                ...
                "rescan_interval": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service, "rescan_interval"),
                    "stat_t": self.mqtt_helper.stat_t(device_id, "service", "rescan_interval"),
                    "cmd_t": self.mqtt_helper.cmd_t(device_id, "rescan_interval"),
                    "unit_of_measurement": "s",
                    "min": 1,
                    "max": 3600,
                    "step": 1,
                ...
                "snapshot_interval": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service, "snapshot_interval"),
                ...
                "reset_discovery": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service, "reset_discovery"),
                ...
                "snapshot_interval_battery_hours": {
                    ...
                    "obj_id": self.mqtt_helper.obj_id(self.service, "snapshot_interval_battery_hours"),
