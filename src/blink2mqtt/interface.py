...
class BlinkServiceProtocol(Protocol):
    ...
    async def set_motion_detection(self: Blink2Mqtt, device_id: str, switch: bool) -> Any | None: ...
    async def take_snapshot_from_device(self: Blink2Mqtt, device_id: str) -> None: ...
    def build_blink_capabilities(self: Blink2Mqtt, device_id: str, attributes: list) -> None: ...
