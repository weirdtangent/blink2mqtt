...
from paho.mqtt.client import Client, MQTTMessageInfo, MQTTMessage
...
class BlinkServiceProtocol(Protocol):
    ...
    def mqtt_on_connect(self, client: Client, userdata: Any, flags: dict, reason_code: ReasonCode, properties: MQTTMessageInfo) -> None: ...
    def mqtt_on_disconnect(self, client: Client, userdata: Any, flags: dict, reason_code: ReasonCode, properties: MQTTMessageInfo) -> None: ...
    def mqtt_on_log(self, client: Client, userdata: Any, paho_log_level: LogLevel, msg: str) -> None: ...
    ...
    def mqtt_safe_publish(self, topic: str, payload: str | bool | int, **kwargs: Any) -> None: ...
